...
USTRUCT()
struct FDRIVE_BoneSourceToTargetMapping
{
	GENERATED_BODY()
...
struct FDRIVE_BoneSourceSettings
{
...
struct DRIVE_TEMPLATERUNTIME_API FAnimNode_CopyPoseRotations : public FAnimNode_Base
{
	...
	TArray<FDRIVE_BoneSourceToTargetMapping> BoneMapping;
...
private:
	...
	TMap<int32, FDRIVE_BoneSourceSettings> BoneMapToSourceSettings;
